$(document).ready(function(){
	...
	$("#formR").validate({		//id en jQuery se especifica anteponiendo #
		rules: {
			reader: {
				required: true,
				alphas: true
  ...
  return this.optional( element ) || /^[1-9]+$/.test( value );
	...
	$("#saveR").prop('disabled', 'disabled');

	$("#formR").on('keyup blur', function(){ //Evento cada que se presione una tecla o posición
		if ($("#formR").valid()){
			//Habilitamos
